...
function displayRequestDetails(request) {
    ...
    requestDetails.innerHTML = `
        <div class="details-content">
            ...
            <div class="detail-item"><span class="detail-label">Full Name:</span> <span class="detail-value">${request.fullName}</span></div>
            <div class="detail-item"><span class="detail-label">Professor Name:</span> <span class="detail-value">${request.professorName}</span></div>
            <div class="detail-item"><span class="detail-label">Program:</span> <span class="detail-value">${request.program}</span></div>
            <div class="detail-item"><span class="detail-label">Section:</span> <span class="detail-value">${request.section}</span></div>
            <div class="detail-item"><span class="detail-label">Year:</span> <span class="detail-value">${request.year}</span></div>
